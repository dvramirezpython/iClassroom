...
#TODO Uncomment next line and comment the following to get YoloV5 back.
...
def parse_opt(known=False):
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=400, help='train, val image size (pixels)')
