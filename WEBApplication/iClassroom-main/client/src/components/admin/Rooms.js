...
/**------------------------------------------------------------------------
 **                           Rooms
 *?  Renders a list of the entries for the given resource (Rooms)
 *------------------------------------------------------------------------**/
function Rooms() {
 ...
 /**
  ...
  const fetchRooms = async () => {
    const options = {method: 'GET', url: `${api_endpoint}/rooms`};
  ...
  return (
    <div className='py-4 px-2'>
      <div className='flex flex-row items-center gap-3'>
        <h1 className='font-extrabold text-dark-blue'>Salones</h1>
        <button>
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              {rooms && rooms.map((room) => (
                  <tr key = {room._id} className="bg-white border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-300">
                    ...
                    <td className="px-6 py-4 text-right">
                        <button
                           onClick={() => {
                            navigate("/room/edit", { state: { room: room } });
                           }}
                        >
