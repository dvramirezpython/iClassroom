...
/**------------------------------------------------------------------------
 **                           EditSchool
 *?  Renders form to edit an existing school 
 *------------------------------------------------------------------------**/
function EditSchool() {
  ...
  const updateSchool = () => {
    const options = {
      method: 'POST',
      url: `http://localhost:5000/school/update/${state.school._id}`,
      ...
      buttons: [
        {
          ...
          onClick: () => {
            ...
            const options = {
              method: 'GET',
              url: `http://localhost:5000/school/delete/${state.school._id}`,
              headers: {'Content-Type': 'application/json'}
            };
    ...
    <div>
      <div className = "edit-container">
        <div className='flex flex-row items-center gap-4'>
          <h1 className='mb-2'>Editando Escuela</h1>
        ...
        <div className="text-center justify-content-center">
          ...
          <div className='flex flex-row gap-2'>
            <button className='btn-admin-forms' onClick={()=>{updateSchool()}}>
              Actualizar registro
            </button>
            <button className='btn-admin-forms-back' onClick={()=>{navigate("/admin", { state: { resource: 'schools' } });}}>
              Regresar
            </button>
          </div>
        </div>
